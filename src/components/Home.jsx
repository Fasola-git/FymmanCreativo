                ...
                <div className=" flex flex-col gap-10 lg:gap-0 lg:flex lg:flex-row lg:justify-evenly lg:items-center lg:basis-4/5">
                    <div className="grid gap-5 lg:flex lg:flex-col lg:gap-16 lg:w-1/3">
                        <div className="pl-6 lg:pl-0 lg:flex lg:flex-col lg:gap-6">
                            ...
                            <div>
                                <p className="lg:text-4xl lg:ps-3 text-9">Agencia de Publicidad & </p>
                                <p className="lg:text-4xl lg:ps-3 text-9">Maketing Digital</p>
                            </div>
                            <div>
                                <h2 className="text-3xl  lg:text-5xl text-7">HAGAMOS ALGO DE</h2>
                                <h2 className=" text-3 text-3xl lg:text-6xl">CREATIVIDAD</h2>
                            </div>
                        </div>
                        <a className="bg-5 rounded-md w-1/2 h-[150%] flex justify-center items-center justify-self-center border-2 border-3 lg:h-16 lg:w-[80%] lg:mx-4 lg:rounded-full lg:text-3xl cursor-pointer text-center hover:bg-violet-400 hover:text-2 transition-all duration-300" href="https://wa.me/93814667211?text=Hola!%20Me%20gustaría%20contactar%20con%20ustedes!">Contáctanos Aquí</a>
                    </div>
