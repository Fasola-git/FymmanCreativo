            ...
            <div id="Home" className="lg:h-screen bg-1 lg:flex lg:flex-col lg:pt-16 lg:justify-around" >
                <div className="lg:flex lg:justify-evenly lg:items-center lg:basis-4/5">
                    ...
                    <div className="lg:flex lg:flex-col lg:items-center lg:w-1/3">
                        <img src="../../public/img/logo.png" className=" w-7/12 place-self-center ps-4" alt="" />
                        <h1 className=" text-7 lg:text-9xl lg:place-self-center">FYMMAN</h1>
                        <h6 className=" text-3 lg:text-5xl lg:tracking-widest lg:place-self-center">C R E A T I V O</h6>    
                    </div>
                </div>
