            ...
            <section id="Nosotros" className="min-h-[90dvh] gap-8 flex flex-col items-center justify-evenly pb-[3dvh] lg:gap-5 lg:pt-[5dvh] bg-cover bg-no-repeat bg-[center_bottom_-0rem]" style={{backgroundImage: 'url("../../img/ondas-nosotros.svg")'}}>
                ...
                <div className="flex flex-col gap-3 ms-[10dvw]">
                    <div className="flex flex-row justify-start items-center gap-3 text-7">
                        ...
                        <p className="lg:text-2xl md:text-3xl">@fymmancreativo </p>
                    </div>
                    <div className="flex flex-row justify-start items-center gap-3 text-7">
                        ...
                        <p className="lg:text-2xl md:text-3xl">fymmancreativo@gmail.com </p>
                    </div>
                    <div className="flex flex-row justify-start items-center gap-3 text-7">
                        ...
                        <p className="lg:text-2xl md:text-3xl">+54 9 381 4667 211</p>
                    </div>
                </div>
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-5 lg:mx-[10dvw] justify-evenly items-center flex-nowrap">
                    ...
                    <div className="flex flex-col justify-center items-center gap-5 lg:max-w-[20%] max-w-[50%]">
                        ...
                        <div className="flex flex-col gap-3 items-center justify-center">
                            <p className="underline">Ejecutivo </p>
                            <p className="text-xl">Carlos Ortiz</p>
                        </div>
                    </div>
                    <div className="flex flex-col justify-center items-center gap-5 lg:max-w-[20%] max-w-[50%]">
                        <div className="rounded-full flex justify-center ">
                        ...
                        <div className="flex flex-col gap-3 items-center justify-center">
                            ...
                            <p className="text-xl">Marcos Solá</p>
                        </div>
                    </div>
                </div>
            </section>
