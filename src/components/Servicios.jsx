...
export default function Servicios(){
    ...
    return(
        <section id="Servicios" className="min-h-screen gap-5 flex flex-col items-center bg-7 pb-[5dvh] lg:pb-[15dvh] lg:gap-20 bg-cover bg-no-repeat bg-[center_bottom_-5rem]" style={{backgroundImage: 'url("../../public/img/Ondas2.svg")'}}>
            ...
            <div className=" grid grid-cols-1 lg:grid-cols-2 gap-y-10 lg:gap-y-16 mb-[15dvh]">
                ...
                <div className=" flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                    <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                        ...
                        <p className="text-2 text-lg md:text-2xl">La tarea principal de un Comunity Manager es mantener y planificar la comunicación del contenido publicitario de una Empresa o Marca, a traves de estrategias comerciales.</p>
                        <ul>
                            ...
                            <li className="text-2 text-lg md:text-2xl"><span className="text-8  text-xl">-</span> Publicita.</li>
