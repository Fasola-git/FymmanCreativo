                    ...
                    <div className=" grid grid-cols-1 lg:grid-cols-2 gap-y-10 lg:gap-y-16 mb-[15dvh]">
                        <div className=" flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">MAGEN CORPORATIVA</h3>
                        ...
                        <div className=" flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">LOGOTIPO</h3>
                            ...
                            <div className="max-w-[65%] lg:max-w-[25%] lg:px-[2.5%] flex flex-col justify-center items-center">
                                <img src="../../public/img/logo.png" className="w-full" alt="" />
                            </div>
                        </div>
                        <div className=" flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">ESTILO DE MARCA</h3>
                        ...
                        <div className="flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">PÁGINA WEB</h3>
                        ...
                        <div className=" flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">IDENTIDAD SONORA </h3>
                        ...
                        <div className="flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">CRM</h3>
                        ...
                        <div className=" flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">COMUNITY MANAGER</h3>
                        ...
                        <div className=" flex flex-col gap-5 lg:gap-0 lg:flex-row items-center w-full lg:justify-evenly lg:h-full">
                            <div className="flex flex-col gap-5 mx-[5%] lg:gap-10 lg:w-1/2">
                                <h3 className="text-2 text-xl lg:text-3xl">DOCUMENTOS </h3>
